...
def crear_calendario():
    ...
    for jornada, partidos in enumerate(calendario):
        for partido in partidos:
            ...
            nuevo_partido = Partidos(fecha=fecha, hora=hora, id_equipo_local=equipo_local, id_equipo_visitante=equipo_visitante, jornada=jornada+1, jugado=False, cancha_id=1, arbitro=1)
